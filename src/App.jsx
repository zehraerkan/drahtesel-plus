...
const COLORS = {
  bg:"#e8f0f7",surface:"#ffffff",card:"#f0f6fc",accent:"#1a56a0",
  accentDim:"#1245800",green:"#16a34a",red:"#dc2626",blue:"#1a56a0",
  orange:"#ea580c",purple:"#7c3aed",teal:"#0891b2",text:"#0f1f3d",muted:"#5a7a9a",border:"#c5d9ed",
};
const STATUS = {
...
const LEISTUNGSKATALOG = [
  {gruppe:"Inspektion & Wartung — Cityrad / Tourenrad",items:[
    {name:"Kleine Inspektion Cityrad",preis:39},
    {name:"Große Inspektion Cityrad",preis:69},
    {name:"Generalüberholung Cityrad",preis:139},
    {name:"Saisoncheck Frühjahr/Herbst (Cityrad)",preis:45},
    {name:"Erstinspektion (Neukauf)",preis:35},
    {name:"Verkehrssicherheitsprüfung",preis:25},
    {name:"Basisreinigung + Schmierung",preis:25},
  ]},
  {gruppe:"Inspektion & Wartung — E-Bike / Pedelec",items:[
    {name:"Kleine Inspektion E-Bike",preis:59},
    {name:"Große Inspektion E-Bike",preis:99},
    {name:"Generalüberholung E-Bike",preis:179},
    {name:"Erstinspektion E-Bike (Neukauf)",preis:55},
    {name:"E-Bike Diagnose / Fehleranalyse",preis:45},
    {name:"Software-Update (Bosch/Shimano/Fazua)",preis:39},
    {name:"Akku-Diagnose & Kapazitätstest",preis:29},
    {name:"Motor-Reinigung & Pflege",preis:35},
  ]},
  {gruppe:"Inspektion & Wartung — Mountainbike",items:[
    {name:"Kleine Inspektion MTB",preis:49},
    {name:"Große Inspektion MTB",preis:89},
    {name:"Generalüberholung MTB",preis:159},
    {name:"Federgabel Service (einfach)",preis:59},
    {name:"Federgabel Service (komplett)",preis:99},
    {name:"Dämpfer Service",preis:79},
    {name:"Hydraulik Bremse entlüften (je Bremse)",preis:35},
  ]},
  {gruppe:"Inspektion & Wartung — Lastenrad / Spezialrad",items:[
    {name:"Kleine Inspektion Lastenrad",preis:59},
    {name:"Große Inspektion Lastenrad",preis:109},
    {name:"Große Inspektion Lasten-E-Bike",preis:149},
    {name:"Generalüberholung Lastenrad",preis:189},
  ]},
  {gruppe:"Bremsen",items:[
    {name:"Bremsklötze tauschen + einstellen (1 Bremse)",preis:18},
    {name:"Bremsklötze tauschen + einstellen (beide)",preis:32},
    {name:"Bremsbelag Scheibenbremse tauschen (1 Seite)",preis:35},
    {name:"Bremsbelag Scheibenbremse tauschen (beide)",preis:62},
    {name:"Bremsscheibe tauschen",preis:25},
    {name:"Bremsscheibe säubern / entfetten",preis:12},
    {name:"Hydraulikbremse entlüften (je Bremse)",preis:35},
    {name:"Bremszug + Hülle tauschen + einstellen",preis:22},
    {name:"Bremse einstellen (ohne Teile)",preis:12},
    {name:"Bremshebel tauschen",preis:18},
    {name:"Bremszug innengeführt — Mehraufwand",preis:25},
  ]},
  {gruppe:"Antrieb & Schaltung",items:[
    {name:"Kette tauschen",preis:15},
    {name:"Kassette tauschen",preis:22},
    {name:"Kette + Kassette tauschen",preis:32},
    {name:"Kettenblatt tauschen",preis:25},
    {name:"Kettenschaltung einstellen (vorne + hinten)",preis:22},
    {name:"Nabenschaltung einstellen inkl. Kette spannen",preis:28},
    {name:"Schaltzug + Hülle tauschen + einstellen",preis:28},
    {name:"Schaltwerk tauschen + einstellen",preis:35},
    {name:"Umwerfer tauschen + einstellen",preis:30},
    {name:"Schalthebel tauschen",preis:25},
    {name:"Tretlager tauschen (Cartridge)",preis:35},
    {name:"Tretlager tauschen (Innenlager)",preis:45},
    {name:"Kurbel / Kurbelarm tauschen",preis:25},
    {name:"Pedale tauschen",preis:15},
    {name:"Riemenantrieb spannen / einstellen",preis:18},
    {name:"Riemenantrieb tauschen",preis:35},
  ]},
  {gruppe:"Laufräder & Reifen",items:[
    {name:"Schlauch tauschen vorne",preis:15},
    {name:"Schlauch tauschen hinten",preis:20},
    {name:"Reifen tauschen (1 Stück)",preis:12},
    {name:"Reifen + Schlauch tauschen (1 Rad)",preis:25},
    {name:"Pannenschutz / Reifenmilch einbringen",preis:12},
    {name:"Laufrad zentrieren",preis:28},
    {name:"Speiche tauschen vorne (bis 4 Stk)",preis:35},
    {name:"Speiche tauschen hinten (bis 4 Stk)",preis:45},
    {name:"Laufrad komplett tauschen (vorne)",preis:25},
    {name:"Laufrad komplett tauschen (hinten)",preis:35},
    {name:"Nabendynamo einbauen + verkabeln",preis:45},
    {name:"Vorderrad mit Nabendynamo",preis:130},
    {name:"Luftdruck prüfen + auffüllen",preis:5},
  ]},
  {gruppe:"Beleuchtung & Elektronik",items:[
    {name:"Frontlicht montieren / tauschen",preis:15},
    {name:"Rücklicht montieren / tauschen",preis:15},
    {name:"Fehlersuche Beleuchtung",preis:20},
    {name:"Kabelverbindung reparieren",preis:18},
    {name:"Akku Licht tauschen",preis:12},
    {name:"E-Bike Display tauschen",preis:25},
    {name:"E-Bike Ladegerät prüfen",preis:15},
    {name:"Software-Update E-Bike",preis:39},
  ]},
  {gruppe:"Lenker, Sattel & Cockpit",items:[
    {name:"Sattel tauschen",preis:12},
    {name:"Sattelstütze tauschen",preis:15},
    {name:"Sattelstütze klemmen / einstellen",preis:8},
    {name:"Dropper-Post Service",preis:45},
    {name:"Lenker tauschen",preis:22},
    {name:"Vorbau tauschen",preis:20},
    {name:"Lenkergriffe tauschen",preis:10},
    {name:"Lenkerband wickeln (Rennrad)",preis:20},
    {name:"Lenkkopflager einstellen",preis:18},
    {name:"Lenkkopflager tauschen",preis:45},
    {name:"Klingel / Hupe montieren",preis:8},
  ]},
  {gruppe:"Rahmen & Sicherheit",items:[
    {name:"Verkehrssicherheitsprüfung",preis:25},
    {name:"Rahmenvermessung nach Sturz/Unfall",preis:45},
    {name:"Kostenvoranschlag für Versicherung",preis:50},
    {name:"Durchsicht nach Sturz (ohne Vermessung)",preis:35},
    {name:"Schutzblech montieren (1 Stk)",preis:15},
    {name:"Schutzblech montieren (vorne + hinten)",preis:25},
    {name:"Kettenschutz montieren",preis:15},
    {name:"Ständer tauschen",preis:12},
  ]},
  {gruppe:"Zubehör & Montage",items:[
    {name:"Gepäckträger montieren",preis:20},
    {name:"Kindersitz montieren",preis:20},
    {name:"Fahrradschloss montieren",preis:10},
    {name:"Fahrradkorb montieren",preis:12},
    {name:"Spiegel montieren",preis:8},
    {name:"GPS-Halterung montieren",preis:10},
    {name:"Fahrradcomputer montieren",preis:15},
    {name:"Fahrradanhänger-Kupplung montieren",preis:25},
  ]},
  {gruppe:"Reinigung & Pflege",items:[
    {name:"Basisreinigung Fahrrad",preis:25},
    {name:"Komplette Reinigung + Pflege",preis:45},
    {name:"Komplette Reinigung E-Bike",preis:55},
    {name:"Kette reinigen + schmieren",preis:12},
    {name:"Antrieb reinigen + schmieren",preis:22},
    {name:"Wintervorbereitung (Fetten + Pflege)",preis:35},
  ]},
  {gruppe:"Beratung & Sonstiges",items:[
    {name:"Fahrradberatung (30 Min.)",preis:25},
    {name:"Einstellung Neukauf (30 Min.)",preis:20},
    {name:"Fahrrad aufbauen (Karton-Lieferung)",preis:45},
    {name:"Fahrrad einschleppen (Berlin Innenstadt)",preis:40},
  ]},
];
const WA_TEMPLATES = [
...
function showToastGlobal(msg,art){
  ...
  div.style.cssText=`position:fixed;bottom:24px;right:24px;background:${art==="err"?"#dc2626":"#16a34a"};color:#fff;border-radius:10px;padding:12px 20px;font-weight:600;font-size:13px;z-index:9999;box-shadow:0 4px 20px #0008;font-family:sans-serif`;
...
// ═══════════════════════════════════════════════════════════════════════════════
// FAHRRAD-VERMIETUNG (BİSİKLET KİRALAMA) — çoklu bisiklet destekli
// ═══════════════════════════════════════════════════════════════════════════════
...
// Geriye dönük uyum: eski kayıtlar tek fahrrad/rahmennummer alanı kullanıyordu.
// Yeni kayıtlar fahrraeder dizisi kullanır. Bu yardımcı ikisini de normalize eder.
function getFahrraeder(v){
  if(Array.isArray(v.fahrraeder)&&v.fahrraeder.length>0)return v.fahrraeder;
  if(v.fahrrad)return [{fahrrad:v.fahrrad,rahmennummer:v.rahmennummer||"",zubehoer:v.zubehoer||"",zustand:v.zustand||""}];
  return [];
}
function fahrraederKurz(v){
  const arr=getFahrraeder(v);
  if(arr.length===0)return "—";
  if(arr.length===1)return arr[0].fahrrad;
...
function VermietungScreen({vermietungen,kunden,envanter,mietraeder,isMobile,showToast,showConfirm,firma,onEkle,onStatus,onGuncelle,onSil}){
  ...
  const gefiltert=useMemo(()=>{
    return [...vermietungen]
      ...
      .filter(v=>!suche||`${v.nummer} ${v.mieterName||""} ${fahrraederKurz(v)}`.toLowerCase().includes(suche.toLowerCase()));
    ...
    <div>
      ...
      <div style={{display:"flex",flexDirection:"column",gap:8}}>
        {gefiltert.map(v=>{
          ...
          const anzahl=getFahrraeder(v).length;
          return(
            <div key={v.id} onClick={()=>{setSelV(v);setAnsicht("detail");}}
              ...
              <div style={{flex:1,minWidth:0}}>
                <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:4,flexWrap:"wrap"}}>
                  ...
                  <span style={{fontSize:10,fontWeight:700,background:vs.bg,color:vs.farbe,borderRadius:8,padding:"1px 8px"}}>{vs.label}</span>
                  {anzahl>1&&<span style={{fontSize:10,fontWeight:700,background:COLORS.accent+"18",color:COLORS.accent,borderRadius:8,padding:"1px 8px"}}>👨‍👩‍👧‍👦 {anzahl} Räder</span>}
                </div>
                <div style={{color:COLORS.muted,fontSize:12,display:"flex",gap:8,flexWrap:"wrap"}}>
                  <span>🚲 {fahrraederKurz(v)}</span>
                  <span>·</span>
...
function VermietungForm({kunden,envanter,mietraeder,isMobile,showToast,onSave,onAbbruch}){
  ...
  const [form,setForm]=useState({
    ...
    fahrraeder:[{fahrrad:"",rahmennummer:"",zubehoer:"",zustand:""}],
  ...
  function recalc(n){
    ...
    const anzahl=(n.fahrraeder||[]).length||1;
    if(tp>0)n.preis=(tage*tp*anzahl).toFixed(2);
    return n;
  }
  const F=(k,v)=>setForm(p=>recalc({...p,[k]:v}));

  // Bisiklet dizisi işlemleri
  function radAendern(idx,key,val){
    setForm(p=>{
      const fahrraeder=p.fahrraeder.map((r,i)=>i===idx?{...r,[key]:val}:r);
      return {...p,fahrraeder};
    });
  }
  function radHinzu(){
    setForm(p=>recalc({...p,fahrraeder:[...p.fahrraeder,{fahrrad:"",rahmennummer:"",zubehoer:"",zustand:""}]}));
  }
  ...
  const radAnzahl=form.fahrraeder.length;
  ...
  async function speichern(){
    ...
    const gecerliRad=form.fahrraeder.filter(r=>r.fahrrad&&r.fahrrad.trim());
    if(gecerliRad.length===0){showToast("Bitte mindestens ein Fahrrad angeben.","err");return;}
    setSaving(true);
    try{
      // Sadece dolu bisikletleri kaydet
      await onSave({...form,fahrraeder:gecerliRad});
    }
  ...
  return(
    <div style={{maxWidth:"100%"}}>
      ...
      <div style={{background:COLORS.card,border:`1px solid ${COLORS.border}`,borderRadius:12,padding:"16px 18px",marginBottom:14}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
          <div style={{fontWeight:600,fontSize:12,color:COLORS.muted,letterSpacing:.5}}>🚲 FAHRRÄDER ({radAnzahl})</div>
        ...
        {form.fahrraeder.map((rad,idx)=>(
          <div key={idx} style={{border:`1px solid ${rad.mietradId?COLORS.accent+"66":COLORS.border}`,borderRadius:8,padding:"12px",marginBottom:10,background:COLORS.surface}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:8}}>
              <input placeholder="Zubehör (Helm, Schloss…)" value={rad.zubehoer} onChange={e=>radAendern(idx,"zubehoer",e.target.value)} style={inputStyle}/>
              <input placeholder="Zustand bei Übergabe" value={rad.zustand} onChange={e=>radAendern(idx,"zustand",e.target.value)} style={inputStyle}/>
            </div>
          </div>
        ))}
      </div>
      ...
      <div style={{background:COLORS.card,border:`1px solid ${COLORS.border}`,borderRadius:12,padding:"16px 18px",marginBottom:14}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMobile?"1fr":"1fr 1fr",gap:10,marginTop:10}}>
          <div><label style={labelStyle}>Tagespreis / Rad (€)</label><input type="number" step="0.01" placeholder="0.00" value={form.tagespreis} onChange={e=>F("tagespreis",e.target.value)} style={inputStyle}/></div>
        ...
        {form.tagespreis&&radAnzahl>1&&(
          <div style={{marginTop:8,fontSize:12,color:COLORS.muted}}>
            {radAnzahl} Räder × {tage} {tage===1?"Tag":"Tage"} × {formatEuro(form.tagespreis)} = <strong style={{color:COLORS.accent}}>{formatEuro(form.preis||0)}</strong>
          </div>
        )}
      </div>
...
function VermietungDetail({vermietung,firma,isMobile,showConfirm,onStatus,onSil,onAbbruch}){
  ...
  const raeder=getFahrraeder(v);

  function drucken(){
    if(!printRef.current)return;
    const win=window.open("","_blank");
    if(!win)return;
    const raederHtml=raeder.map((r,i)=>`
      <div class="box">
        <div class="label">Fahrrad ${raeder.length>1?(i+1):""}</div>
        <div class="row"><span>Fahrrad:</span><span>${r.fahrrad||"—"}</span></div>
        ${r.rahmennummer?`<div class="row"><span>Rahmennummer:</span><span>${r.rahmennummer}</span></div>`:""}
        ${r.zubehoer?`<div class="row"><span>Zubehör:</span><span>${r.zubehoer}</span></div>`:""}
        ${r.zustand?`<div class="row"><span>Zustand bei Übergabe:</span><span>${r.zustand}</span></div>`:""}
      </div>`).join("");
    win.document.write(`<html><head><title>Mietvertrag ${v.nummer}</title>
      ...
      <div class="box">
        ...
        <div class="row"><span>Anzahl Fahrräder:</span><span>${raeder.length}</span></div>
      ...
      <div class="box" style="margin-top:16px;">
        ...
        <div class="agb">
          1. Der Mieter bestätigt, die Fahrräder in ordnungsgemäßem und verkehrssicherem Zustand erhalten zu haben.<br/>
          2. Die Fahrräder sind pfleglich zu behandeln und zum vereinbarten Zeitpunkt zurückzugeben.<br/>
          3. Bei Beschädigung, Verlust oder Diebstahl haftet der Mieter in voller Höhe des Zeitwerts.<br/>
          4. Eine verspätete Rückgabe wird mit dem vereinbarten Tagespreis je angefangenem Tag und Fahrrad berechnet.<br/>
          5. Der Mieter fährt auf eigene Gefahr. Der Vermieter haftet nicht für Unfälle oder Schäden Dritter.<br/>
          6. Die Fahrräder dürfen nicht an unbefugte Dritte weitergegeben werden.<br/>
  ...
  return(
    <div style={{maxWidth:"100%"}}>
      ...
      <div style={{background:COLORS.card,border:`1px solid ${COLORS.border}`,borderRadius:12,padding:"16px 18px",marginBottom:14}}>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
          {v.status==="Aktiv"&&(
            <button onClick={()=>showConfirm("Alle Fahrräder wurden zurückgegeben?",()=>onStatus(v.id,"Zurückgegeben"),{icon:"✓",okLabel:"Zurückgegeben",okColor:COLORS.green})}
      ...
      <div ref={printRef} style={{background:COLORS.surface,border:`1px solid ${COLORS.border}`,borderRadius:12,padding:"18px 20px"}}>
        ...
        <div style={{fontSize:12,fontWeight:700,color:COLORS.muted,marginBottom:8}}>🚲 FAHRRÄDER ({raeder.length})</div>
        {raeder.map((r,i)=>(
          <div key={i} style={{border:`1px solid ${COLORS.border}`,borderRadius:8,padding:"10px 12px",marginBottom:8}}>
            <div style={{fontWeight:600,fontSize:13,marginBottom:4}}>{raeder.length>1?`${i+1}. `:""}{r.fahrrad}</div>
            {r.rahmennummer&&<div style={{fontSize:12,color:COLORS.muted}}>Rahmen: {r.rahmennummer}</div>}
            {r.zubehoer&&<div style={{fontSize:12,color:COLORS.muted}}>Zubehör: {r.zubehoer}</div>}
            {r.zustand&&<div style={{fontSize:12,color:COLORS.muted}}>Zustand: {r.zustand}</div>}
          </div>
        ))}
        <div style={{height:1,background:COLORS.border,margin:"12px 0"}}/>
